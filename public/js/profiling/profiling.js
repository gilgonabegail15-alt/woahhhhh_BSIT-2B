...
$(document).on('click', '.edit-btn', function () {
   ...
   $.ajax({
    url: baseUrl + 'profiling/edit/' + profilingId,
    method: 'GET',
    dataType: 'json',
    success: function (response) {
        if (response.data) {
            ...
            $('#editUserModal #name').val(response.data.email);
            $('#editUserModal #bday').val('');
            $('#editUserModal #address').val(response.data.role);
        } else {
